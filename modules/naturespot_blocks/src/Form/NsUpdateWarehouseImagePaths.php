...
/**
 * Form for updating image link file paths after warehouse media path update.
 */
class NsUpdateWarehouseImagePaths extends FormBase {

  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'update_warehouse_image_paths_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['description'] = [
      '#markup' => '<p>Use this form to upload a CSV file containing changes to warehouse image paths.</p>',
    ];
